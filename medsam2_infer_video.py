...
from sam2.build_sam import build_sam2_video_predictor, get_best_available_device

# Determine the best available device at import time for use in autocast decorators
...
@torch.autocast(device_type=_AUTOCAST_DEVICE, dtype=torch.bfloat16)
def vos_inference(
    predictor,
    base_video_dir,
    input_mask_dir,
